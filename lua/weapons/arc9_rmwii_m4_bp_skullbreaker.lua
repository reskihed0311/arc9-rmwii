...
SWEP.CanLean = false
SWEP.Spawnable = true
SWEP.Category = "ARC9 - Warzone 2.0 - Blueprints"
SWEP.SubCategory = "Assault Rifle"

SWEP.StandardPresets = {
    "[M4 - Skull Breaker]XQAAAQDoAAAAAAAAAAA9iIIiM7tuo1AtUDA7pgliTAQq87tvxhGhyF4BAwEU0dBAV3q/MkFoMy/6FbCUKhDOsoo9+1QRNvJJiEqD+5VhTq8hHKQMZZnIwdeIUb+T8gvbdrlxO4dwrOtH7KM0a78ccEWDddNDjb1opeK9ppBCY98Zi9Nx5ftsbUIOWQA="
}

SWEP.FreeAimRadius = 0 -- In degrees, how much this gun can free aim in hip fire.
SWEP.FreeAimRadiusMultSights = 0

SWEP.PrintName = "M4 - Skull Breaker"
...
SWEP.ViewModel = "models/weapons/r_mwii/ar/blueprints/mike4/arc9_r_mwii_bp_m4_skullbreaker.mdl"
...
SWEP.Attachments = {
    ...
    } ,
   {
    ...
    },
    {
        ...
        RejectAttachments = { ["wz2_m4_xmag"] = true }, -- Specifically refuse to allow certain attachments to be attached
        Category = {"wz2_m4_mags", "wz2_m4_mags_skullbreaker"},
        Bone = "mag",
        Pos = Vector(0,0,0),
        Ang = Angle(90,-90,0),
    } ,
